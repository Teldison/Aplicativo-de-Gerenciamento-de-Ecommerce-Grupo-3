...
const styles = StyleSheet.create({
  container: {
    ...
    backgroundColor: '#6e2900', // cor de fundo
  },
  containerButton: {
    marginBottom: 16,
  },
  ...
  itemContainer: {
    ...
    aspectRatio: 1,
    borderWidth: 2,
    borderColor: '#3b1e00', // borda escura estilo viking
    shadowColor: '#000',
    shadowOffset: { width: 2, height: 2 },
    shadowOpacity: 0.8,
    shadowRadius: 2,
    elevation: 5,
    overflow: 'hidden', // Assegura que a imagem não exceda os limites do container
    position: 'relative', // Para garantir que a imagem de fundo seja posicionada corretamente
  },
  imagemProduto: {
    width: '100%',
    height: '70%',
    borderRadius: 8,
    resizeMode: 'contain', // Adiciona o ajuste da imagem
  },
  semImagem: {
    width: '100%',
    height: '70%',
  ...
  itemNome: {
    ...
    color: '#fff',
    marginTop: 10,
    fontFamily: 'Georgia', // Aplicando fonte Georgia
  },
  itemPreco: {
    fontWeight: '500',
    fontSize: 20,
